...
// Fungsi untuk menandai opsi select yang terpilih
function is_select($var, $val)
{
    if ($var == $val) return 'selected="selected"';
    return ''; // Mengubah return false menjadi string kosong untuk output HTML yang bersih
}
...
if (isset($_POST['submit'])) {
    ...
    if ($file_gambar['error'] == 0) {
        // Perbaikan logika str_replace (asli PDF salah)
